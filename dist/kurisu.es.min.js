...
var isNil$1 = function isNil(val) {
  return typeof val === 'undefined' || val === null || val === '' ? true : false;
}; // 判断是否是JSON字符串


var isJsonString$1 = function isJsonString(str) {
  try {
...
export { addSessionStorage, countdown, delCookie, delSessionStorage, filterEmoji, getCookie, getHtmlDocName, getNum, getQueryString, getSessionStorage, isAndroid, isCodeLegal, isEmailLegal, isIOS, isIdLegal, isJsonString$1 as isJsonString, isNil$1 as isNil, isPasswordLegal, isPhoneLegal, isWxBrowser, randomStr, reloadPage, setCookie, sliceStr, timeTaken };
